...
func (dq *DataQuery) AddFn(condition bool, fn func(model *gdb.Model)) *DataQuery {
	if condition && fn != nil {
		fn(dq.model)
	}
	return dq
...
func (dq *DataQuery) OrderAsc(field string) *DataQuery {
	if field != "" {
		dq.model = dq.model.OrderAsc(field)
	}
	return dq
}

func (dq *DataQuery) OrderDesc(field string) *DataQuery {
	if field != "" {
		dq.model = dq.model.OrderDesc(field)
	}
	return dq
}

func (dq *DataQuery) OrderBy(orderBy ...string) *DataQuery {
	if orderBy != nil && len(orderBy) > 0 {
		dq.model = dq.model.Order(orderBy...)
	}
	return dq
}
...
func (du *DataUpdate) Add(condition bool, field string, val interface{}) *DataUpdate {
	return du.Set(condition, field, val)
}

func (du *DataUpdate) Set(condition bool, field string, val interface{}) *DataUpdate {
	if condition && field != "" {
...
func (du *DataUpdate) SetFn(condition bool, field string, fn func() interface{}) *DataUpdate {
	if condition && field != "" && fn != nil {
		val := fn()
		if val != nil {
			du.dataVal[field] = val
		}
